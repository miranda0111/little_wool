...
function po(url,body=''){
    let host = url.replace('//','/').split('/')[1]
    let urlObject = {
        url: url,
        headers: {"Accept-Encoding": "gzip,compress,br,deflate","Connection": "keep-alive","Content-Length": "579","Host": "minigame.nagagame.net","Referer": "https://servicewechat.com/wxd09d0ccbafdb38e1/10/page-frame.html","User-Agent": "Mozilla/5.0 (iPhone; CPU iPhone OS 14_8 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148 MicroMessenger/8.0.20(0x18001442) NetType/WIFI Language/zh_CN","Content-Type": "application/json"},
    }
